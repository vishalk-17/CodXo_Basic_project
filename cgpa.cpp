...
int main()
{
    ...
    int input;
    cout<<"--------------------------------------------------------------------------"<<endl;
    cout<<"                    GPA & CGPA Calculator (Developed by VISHAL)             "<<endl;
    cout<<"--------------------------------------------------------------------------\n"<<endl;
    cout<<"            MENU:"<<endl;
...
--------------------------------------------------------------------------
                    GPA & CGPA Calculator (Developed by VISHAL)
--------------------------------------------------------------------------

            MENU:
                   1. Calculate GPA (Grade Point Average)
                   2. Calculate CGPA (Cummulative Grade Point Average)
                   3. Method that is applied here for calclating GPA & CGPA
                   4. Exit Application
--------------------------------------------------------------------------
Enter your choice: 2
...
How many semester results do you want input? :3



 Enter Semester 1 Result(GPA): 8.36


 Enter Semester 2 Result(GPA): 8.56


 Enter Semester 3 Result(GPA): 9.20


******** Your CGPA is 8.70667 **********
